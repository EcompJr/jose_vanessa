        ...
        <header id="header">
            <div class="container-fluid" style="display: flex;align-items: center">
                <div id="logo" class="col-3">
                    <a href="index.html" class="scrollto"><img src="{{asset('images/apae2.png')}}" class:"img-fluid" style="width:60px;height:60px" alt=""></a>
                </div>
            ...
            <div class="col-10 offset-1">
                <section id="paginaAdmin">
                    ...
                    <section class="areaAdm ">
                        <button class="btn btn-success text-left" action="" method="POST" href="{{ url('/cadastrarMembro') }}" style=" margin-bottom: 10px">Cadastrar Novo Membro</button>
